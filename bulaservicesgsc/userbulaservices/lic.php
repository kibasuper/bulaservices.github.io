...
<body>
  ...
  <main class="main-content">
    <div class="container">
      <section class="form-container">
        ...
        <form id="licForm" enctype="multipart/form-data">
          <input type="hidden" name="csrf_token" value="<?= e($csrfToken) ?>">
          <input type="hidden" name="service_type" value="low_income">
          ...
          <!-- Section 2 (Purpose radios like bc.php) -->
  ...
  <script>window.LIC_PRICE = <?= json_encode((float)$LIC_PRICE) ?>;</script>
  <script src="./script/lic.js?v=3"></script>
</body>
</html>
