...
// Require login (keeps files private to the user area)
...
// 2) base uploads dir from config constant
$uploadsDir = realpath(UPLOADS_DIR);
if ($uploadsDir === false) {
    error_log('serve_upload_user: UPLOADS_DIR not found: ' . UPLOADS_DIR);
...
if ($fullPath === false || !is_file($fullPath)) {
    error_log("serve_upload_user: 404 rel='$rel' base='$uploadsDir' full='".($fullPath ?: 'false')."'");
