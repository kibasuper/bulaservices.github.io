...
<body>
            ...
            <section class="form-container">
                <div class="progress-steps">
                    ...
                    <div class="step" id="step2">
                        ...
                        <div class="step-label">Purpose & Fees</div>
                    </div>
                ...
                <div class="form-header">
                    ...
                    <p>Fill out the form to request a Certificate of Indigency from Barangay Bula</p>
                </div>
                   
                <form id="indigencyCertificateForm">
                    ...
                    <div class="form-section" id="section3" aria-labelledby="step3">
                        ...
                        <div class="walkin-hours">
                            ...
                            <p class="note">Please bring your valid ID when picking up your certificate.</p>
                        </div>
    ...
    <script src="./script/coi.js"></script>
</body>
</html>