...
try {
    ...
    $PIC_PRICE = isset($row['price']) ? (float)$row['price'] : 100.00; // fallback
} catch (Throwable $e) {
    error_log("PIC price fetch error: " . $e->getMessage());
    $PIC_PRICE = 100.00;
}
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Proof of Income Certificate | Barangay Bula</title>
...
<body>
    ...
    <div class="container">
      <section class="form-container">
        ...
        <div class="form-header">
          <h2><i class="fas fa-file-invoice-dollar"></i> Proof of Income Certificate</h2>
          ...
          <div class="form-section" id="section2" aria-labelledby="step2">
            <div class="purpose-options">
              ...
              <div class="purpose-option" onclick="selectPurpose('Loan')" tabindex="0" role="button" aria-pressed="false">
                <input type="radio" id="loanPurpose" name="purpose" value="Loan Application" required>
              ...
              <div class="purpose-option" onclick="selectPurpose('Scholarship')" tabindex="0" role="button" aria-pressed="false">
                <input type="radio" id="scholarshipPurpose" name="purpose" value="Scholarship">
                <label for="scholarshipPurpose">Scholarship</label>
              </div>
              ...
              <div class="purpose-option" onclick="selectPurpose('Visa')" tabindex="0" role="button" aria-pressed="false">
                <input type="radio" id="visaPurpose" name="purpose" value="Visa Application">
                <label for="visaPurpose">Visa Application</label>
              </div>
            ...
            <div class="fee-calculator">
              ...
              <div id="feeResult" class="fee-result">
                Total Fee: ₱<span id="calculatedFee"><?= number_format($PIC_PRICE, 2) ?></span>
              </div>
            </div>
  ...
  <div id="successModal" class="success-modal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
    <div class="success-modal-content">
      ...
      <p>Your Proof of Income Certificate application has been received.</p>
