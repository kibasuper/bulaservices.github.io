...
<body>
        ...
        <div class="container">
            <section class="form-container">
                ...
                <form id="businessPermitForm" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="service_type" value="business_permit">
                    ...
                    <!-- Section 2: Purpose & Documents (same as bc.php) -->
                    <div class="form-section" id="section2" aria-labelledby="step2">
                        ...
                        <!-- Fee Calculator (DYNAMIC PRICE like bc.php) -->
                ...
                <div class="requirements">
                    ...
                    <ul class="requirements-list">
                        ...
                        <li><i class="fas fa-check-circle"></i><span>Business Registration Docs (if applicable)</span></li>
                    </ul>
                </div>
            </section>
        </div>
    ...
    <!-- Pass the dynamic price to JS -->
    <script>
      window.BP_PRICE = <?= json_encode((float)$BP_PRICE) ?>;
    </script>

    <script src="./script/bp.js?v=3"></script>
</body>
</html>
