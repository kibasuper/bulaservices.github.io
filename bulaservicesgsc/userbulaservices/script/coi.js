...
function calculateFee() {
  ...
  const pricePerCopy = typeof window.INDIGENCY_PRICE === 'number' ? window.INDIGENCY_PRICE : 50;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (perCopyText) {
    const p = typeof window.INDIGENCY_PRICE === 'number' ? window.INDIGENCY_PRICE : 50;
  ...
  formEl?.addEventListener('submit', async function(e) {
    ...
    try {
      ...
      formData.set('service_type', 'indigency'); // enforce correct service
