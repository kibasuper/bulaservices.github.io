...
<body>
            ...
            <section class="form-container">
                <div class="progress-steps">
                    ...
                    <div class="step" id="step2">
                        ...
                        <div class="step-label">Residency Details</div>
                    </div>
                ...
                <div class="form-header">
                    ...
                    <p>Fill out the form to request a Certificate of Residency from Barangay Bula</p>
                </div>
                   
                <form id="residencyCertificateForm">
    ...
    <script src="./script/cor.js"></script>
</body>
</html>